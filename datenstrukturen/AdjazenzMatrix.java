...
public class AdjazenzMatrix {
    ...
    public int entfernung(int pStart, int pZiel) {
        int lAktuellerKnoten = pStart;
        int[] lEntfernung = new int[zN];
        
        for (int i = 0; i < zN; i++) {
            lEntfernung[i] = -1;
        }
        lEntfernung[pStart] = 0;
        
        while ( this.unbesuchteKnoten(lEntfernung) )
        {
            
        }
        
        return lEntfernung[pZiel];
    }
    
    private boolean unbesuchteKnoten(int[] lInt)
    {
